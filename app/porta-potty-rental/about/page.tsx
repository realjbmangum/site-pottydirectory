        ...
        <section className="py-16 bg-gray-50">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="prose prose-lg mx-auto text-gray-600">
              ...
              <p>
                We set out to create a platform that would make this process simple and transparent. Today, we're proud
                to serve thousands of customers across all 50 states, connecting them with the best porta potty rental
